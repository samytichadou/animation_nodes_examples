...
# VARIABLES
nodetree = bpy.data.node_groups['twisted_torus_procedural']
...
for link in nodetree.links:
    ...
    # GET INDEX
    idx_from = link.from_socket.getIndex()
    idx_to = link.to_socket.getIndex()

    # add index
    links_coll[i].update({'from_socket_index': idx_from})
    links_coll[i].update({'to_socket_index': idx_to})
